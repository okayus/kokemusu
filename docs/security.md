...
- → **向き（インプット／アウトプット）と積み上がる「日」の範囲も平文側**（2026-09-06、[ADR-0005](adr/0005-post-axis-is-day-range.md)）:
  偏りの可視化と総草の軸に要る。漏れて分かるのは「いつ・どの石に・吸ったか出したか・いくつ」までで、何をしたかは暗号化された本文にしか無い。

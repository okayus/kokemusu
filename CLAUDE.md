...
4. ~~docs の drift 修正~~ → **PR #3（2026-08-22）**。残: `/grill-with-docs`（`docs/roadmap.md` 決めること 2 暗号化レベル・7 `post.title` の位置づけ・8 mazuoboeru 連携 (i) 自分専用 / (ii) per-user）→ `CONTEXT.md` / `docs/adr/`
